...
def fgw_lp(M,C1,C2,p,q,loss_fun='square_loss',alpha=1,amijo=True,G0=None,**kwargs): 
    ...
    **kwargs : dict
    ...
    return optim.cg(p,q,M,alpha,f,df,G0,log=True,amijo=amijo,C1=C1,C2=C2,constC=constC,**kwargs)


def fgw_partial_lp(M,C1,C2,p,q,m,alpha=1.0,amijo=True,G0=None,**kwargs):
    return optim.partial_cg(p, q, M, alpha, m, G0=G0, log=True, amijo=amijo, C1=C1, C2=C2, **kwargs)
